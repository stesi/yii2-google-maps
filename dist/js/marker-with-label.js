...
(function ($, window, document, undefined) {
    ...
    $(document).one("google.maps.initialized", function () {
        ...
        // Attach to stesi global variable
        window.stesi = window.stesi || {};
        window.stesi.maps = window.stesi.maps || {};
        window.stesi.maps.MarkerWithLabel = MarkerWithLabel;
